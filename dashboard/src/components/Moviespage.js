    ...
    <div className="moviespage">
      ...
      <section id="newReleases">
        ...
        <div id="movieBox" style={{ color: "white" }}>
          {!movieObjects ||
          movieObjects == undefined ||
          movieObjects.length !== 8
            ? "Loading Movies: Please wait..."
            : movieObjects
                .filter((moviez) => moviez.display == true)
                .map((movie, key) => {
                  return (
                    <div
                      key={key}
                      className="newReleaseMovie"
                      onClick={(e) => {
                        e.preventDefault();
                        ...
                        {
                          !movie.flipped &&
                            getIndividualMovieData(plotline, movieId);
                        }
                      }}
                    >
                      {/* {!movie.flipped && (
